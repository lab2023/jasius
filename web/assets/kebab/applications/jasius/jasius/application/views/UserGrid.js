...
KebabOS.applications.jasius.application.views.UserGrid = Ext.extend(Ext.grid.GridPanel, {
    ...
    initComponent: function() {
        ...
        // json data store
        this.comboStore = new KebabOS.applications.jasius.application.models.UserDataStore();
        ...
        KebabOS.applications.jasius.application.views.UserGrid.superclass.initComponent.apply(this, arguments);
    }
});
